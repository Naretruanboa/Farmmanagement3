	...
	<div class=" row form-group">
				<div class="form-inline">
					<div class="col-md-3">
						<div class="jumbotron" style="background-color: rgb(218, 68, 83)"
							align="center">
							<p style="font-size: 28px; font-weight: 700; color: white;">การตั้งสีโค</p>
						</div>
					</div>	
				</div>
		</div>
		...
		<div class="row ">
        					<div class="col-md-6">
        						<div class="panel panel-primary">
        							<div class="panel-heading">
        								<h3 class="panel-title">เพิ่มสีโค</h3>
        							</div>
        							<div class="panel-body">
        								<table >
        									...
        									<tr>
        										<td><h4>สี : </h4></td>
        										<td>
        										<form:form commandName="color" id="color" >
        											<form:input  id="nameColor" path = "value" class="form-control col-md-offset-1"  />
        										</form:form>
												</td>
        										<td>
          				...
          				<div class="col-md-6">
           				 <div class="panel panel-primary">
             				 <div class="panel-heading">
                				<h3 class="panel-title">สีโคที่มี</h3>
             				 </div>
						   	 		...
						   	 		<c:forEach items="${colo }" var="colo">
						     			<tr>	
						        			...
						        			<td>
												...
												value="${colo.id}" onclick="chkdel(this.value)">
...
$(document).on('click','#add',function(e){
	...
	{
		$.post('Checkcolorr',{nameColor:$("#nameColor").val()},function(msg){
			if(msg=="yes"){
				$.ajax({
					url:"addcolor",
					method:"POST",
