...
<div class="panel panel-primary">
	...
	<tr>
		...
		<form:input type="hidden" path="privilege.id" class="form-control"/>
					...
					<a href="set_memberH"><button type="submit" id="cancle" name="action" class="btn btn-embossed btn-danger btn-wide" style="text-align: center;">ยกเลิก</button></a>
					</div>
			...
			$.ajax({
				...
				swal({  title: "สำเร็จ",   
					text: "บันทึกเรียบร้อยแล้ว!", 
						...
						function(){   
							window.location.href='set_memberH'; 
							});
