				...
				<div class="panel-body">
						...
						<div class="row form-group">
							...
							<div class="row form-group">
								...
								<div class="col-md-6">
									<input value="${cattle.color.value }" id="color" type="text" class="form-control" disabled="disabled"/>				
								</div>
							</div>		
							...
							<div class="row form-group">
								...
								<div class="col-md-6">
									<input value="${cattle.groupCattle.value }" id="groupCattle" type="text" class="form-control" disabled="disabled"/>									
								</div>
							</div>		
