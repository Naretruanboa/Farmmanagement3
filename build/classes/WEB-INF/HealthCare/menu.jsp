...
<div class="container-fluid">
	<div class="navbar-header">
		<a class="navbar-brand" href="HealthCare"><img
			src="<c:url value=  "resources/img/PATTERN 3 S-175.png"/> "
...
<%--          <c:if test="${sessionScope.privilege == 1 || sessionScope.privilege == 2}">     
       	...
       	<li class="dropdown" role="menu">
              ...
              <ul class="dropdown-menu">
           <c:if test="${sessionScope.privilege == 1 || sessionScope.privilege ==2 || sessionScope.privilege ==3}">
                <li><a tabindex="-1" href="view_medicineH"><i class="fa fa-pencil-square-o fa-fw"></i>ลงทะเบียนยาใหม่</a></li>
...
<!--        <li class="dropdown" role="menu">
 	...
 	<li class="dropdown" role="menu">
      ...
      <c:if test="${sessionScope.privilege == 1 || sessionScope.privilege ==2 || sessionScope.privilege ==3}">
		...
		<li><a href="<c:url value= "resources/img/healthcare/guide.pdf" />" target=_blank><i class="fa fa-info-circle" aria-hidden="true"></i> คู่มือการใช้งาน</a></li>
