		   	...
		   	<table class="table table-striped table-hover  table-bordered">		  	
			    ...
			    <tbody>		   	
				    ...
				    <td><div align="center">${member.privilege.privilegeName}</div></td>				    
				        <td><center><button type="button" class="btn btn-warning glyphicon glyphicon-edit" data-toggle="modal" data-target="#edit" data-gid="${member.id}"
				        ...
				        <td><center><button type="button" class="btn btn-danger glyphicon glyphicon-trash" data-toggle="modal" data-target="#del" data-did="${member.id}">
				        	</button></center></td>
...
<div class="container">
	...
	$(document).on('click','#btn_save',function(e){
		...
		$.ajax({
			...
			swal({  title: "สำเร็จ!",   
				text: "บันทึกข้อมูลการแก้ไขเรียบร้อยแล้ว!", 
				type: "success",   
