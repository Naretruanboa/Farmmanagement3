<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div class="container">
		...
		<div class="col-md-6">
			<div align="right">
				<a>
					<a class="textright" href="index">Farm Management System : System : Nutrient Requirement System Beef and Dairy Cattle Phase 3</a>
					<img id="imgfooter" src="<c:url value="/resources/img/Nutrient/b13.png" /> " height="45" " title="กลับสู่หน้าหลัก">
				</a> 
			</div>
		</div>
	</div>
