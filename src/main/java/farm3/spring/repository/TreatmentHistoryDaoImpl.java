...
import farm3.spring.dao.TreatmentHistoryDao;
...
/*	public List<TreatmentHistory> getTreatmentHistoryByDate() {
		String date = "SELECT date FROM TreatmentHistory AS date Order By dateTreat asc";
		Query datt = session.getCurrentSession().createQuery(date);
		return datt.list();
	}*/
