...
<title>บันทึกข้อมูลโคเนื้อ</title>
</head>
<body>
...
<div class="container">
				<div class="col-md-3">
					<div class="jumbotron" style="background-color: rgb(218, 68, 83)"
						align="center">
						<p style="font-size: 28px; font-weight: 700; color: white;">แก้ไขข้อมูลโคเนื้อ</p>
					</div>
				</div>
				<div class="row">
					<hr>
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						...
						<span class="fa fa-list-alt fa-lg"></span> แก้ไขข้อมูลโคเนื้อ</a>
						</h4>
					</div>
				
				<div class="panel-body">
					<form:form action="editted_beefTk" modelAttribute="cattle" method="POST" id="cattle" commandName="shc">
						...
						<div class="row form-group">
							<div class="col-md-6">
								<fieldset><br>
									...
									<div class="row form-group">
										<label class="col-md-offset-s col-md-3 control-lable"><font color="red"> </font>หมายเลขทะเบียนโค</label>
										<div class="col-md-6">
											<form:input path="" id="" type="" class="form-control"/>
										</div>
									</div> 	
								...
								<div class="row form-group">
									<label class="col-md-offset-s col-md-3 control-label"><font color="red"> </font> ว/ด/ป เกิด</label>
									<div class="col-md-6">
								...
								<div class="row form-group">
									...
									<!-- <div class="row form-group">
										<label class="col-md-offset-s col-md-3 control-lable"><font color="red">* </font>ประเภทโค</label>
										<div class="col-md-6"> -->
										
											<form:input path="typeCattle.id" id="typeCattle.id" type="hidden" class="form-control" />
									<!-- 	</div>
									</div> -->										
						...
						<%-- <div class="row form-group">
								...
								<div class="row form-group">
										<label class="col-md-offset-s col-md-3 control-lable"><font color="red"> </font>เจ้าของโค </label>
										<div class="col-md-6">
											<form:input path="" id="" type="" class="form-control" disabled="disabled" />
										</div>
								</div> 			
								
								<div class="row form-group">
										<label class="col-md-offset-s col-md-3 control-lable"><font color="red"> </font>ผู้ปรับปรุงพันธุ์</label>
										<div class="col-md-6">
											<form:input path="" id="" type="" class="form-control" disabled="disabled" />
										</div>
								</div> 			
			...
			function(isConfirm){   
				if (isConfirm) {
					if($("#num").val() == ""){
						...
						swal("คุณไม่มีสิทธิ์เปลี่ยนประเภทโค");
					}else{

					$.post('editted_beefTk',$("#cattle").serialize(),
					      function (result) {
					     	swal({	title: "Success!",   
