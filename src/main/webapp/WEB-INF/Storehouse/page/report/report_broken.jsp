       		...
       		<div class="container">
        		<div class="col-md-3">
					<div class="jumbotron" style="background-color: rgb(218, 68, 83)"
						align="center">
						<p style="font-size: 28px; font-weight: 700; color: white;">ออกรายงานการส่งซ่อมอุปกรณ์</p>
					</div>
				</div>
			 </div>
			 <div class="container">
...
$(document).on('click','#btnSeach',function(e){
	...
	if(dateStart==""){
		...
		$("#dataBody").load('search_Broken_pdf',{
			dateStart :dateStart,
			dateEnd : dateEnd
			}
		,function(e){
...
$(document).on('click','#btnReport',function(e){
	...
	window.open("ReportBroken?dateStart="+dateStart+"&dateEnd="+dateEnd);
