       		...
       		<div class="container">
        		<div class="col-md-3">
					<div class="jumbotron" style="background-color: rgb(218, 68, 83)"
						align="center">
						<p style="font-size: 28px; font-weight: 700; color: white;">ออกรายงานการนำเข้า</p>
					</div>
				</div>
			 </div>
<div class="container">
	...
	<div class="panel-body" style="font-size: 18px;">
				...
				<div class="row form-group">
					<div class="col-md-offset-3  col-md-3">
						<div class="col-md-5">
							<p style="font-size: 20px; font-weight: bold;">ชื่อผู้นำเข้า :</p>
						</div>
						<div class="col-md-4">
...
$(document).on('click','#btnSeach',function(e){
	...
	if(idStock==0){
		...
		$("#dataBody").load('search_import_pdf',{
			ididStock : idStock,
			memberid : memberid,
			dateStart :dateStart,
			dateEnd : dateEnd
...
$(document).on('click','#btnReport',function(e){
	...
	window.open("ReportImport?idStock="+idStock+"&memid="+memberid+"&dateStart="+dateStart+"&dateEnd="+dateEnd);
