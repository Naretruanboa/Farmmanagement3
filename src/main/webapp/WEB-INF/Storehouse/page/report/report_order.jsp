       		...
       		<div class="container">
        		<div class="col-md-3">
					<div class="jumbotron" style="background-color: rgb(218, 68, 83)"
						align="center">
						<p style="font-size: 28px; font-weight: 700; color: white;">ออกรายงานการสั่งซื้อ</p>
					</div>
				</div>
			 </div>
<div class="container">
	...
	<div class="panel-body" style="font-size: 18px;">
				<div class="row form-group">
					<div class="col-md-offset-3  col-md-3">
						<div class="col-md-5">
							<p style="font-size: 20px; font-weight: bold;">เลือกคงคลัง :</p>
						</div>
						<div class="col-md-4">
							<select class="form-control" style="font-size: 18px;" id="selectValue" onchange="selectsR(this);">
								<option value="0">กรุณาเลือกประเภทของคลัง</option>
								<option value = "1">ยาคงคลัง</option>
								<option value = "2">น้ำเชื้อคงคลัง</option>
								<option value = "3">วัตถุดิบอาหารสัตว์คงคลัง</option>
								<option value = "4">วัสดุ/อุปกรณ์คงคลัง</option>
							</select>
						</div>
					</div>
				</div>
				<div class="row form-group">
					<div class="col-md-offset-3  col-md-3">
						<div class="col-md-5">
							<p style="font-size: 20px; font-weight: bold;">ชื่อผู้สั่งซื้อ :</p>
						</div>
						<div class="col-md-4">
...
$(document).on('click','#btnSeach',function(e){
	...
	if(idStock==0){
		...
		$("#dataBody").load('search_order_pdf',{
			ididStock : idStock,
			memberid : memberid,
			dateStart :dateStart,
			dateEnd : dateEnd
...
$(document).on('click','#btnReport',function(e){
	...
	window.open("ReportOrder?idStock="+idStock+"&memid="+memberid+"&dateStart="+dateStart+"&dateEnd="+dateEnd);
