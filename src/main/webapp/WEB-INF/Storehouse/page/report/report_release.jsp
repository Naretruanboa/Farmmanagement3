       		...
       		<div class="container">
        		<div class="col-md-3">
					<div class="jumbotron" style="background-color: rgb(218, 68, 83)"
						align="center">
						<p style="font-size: 28px; font-weight: 700; color: white;">ออกรายงานการเบิก</p>
					</div>
				</div>
			 </div>
<div class="container">
...
$(document).on('click','#btnSeach',function(e){
	...
	if(idStock==0){
		...
		$("#dataBody").load('search_release_pdf',{
			ididStock : idStock,
			memberid : memberid,
			dateStart :dateStart,
			dateEnd : dateEnd
...
$(document).on('click','#btnReport',function(e){
	...
	window.open("ReportRelease?idStock="+idStock+"&memid="+memberid+"&dateStart="+dateStart+"&dateEnd="+dateEnd);
