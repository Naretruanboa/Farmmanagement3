...
<head>
    <meta charset="utf-8">
    <title>การแก้ไขบัญชีบัญชียา</title>
</head>
<body>
        ...
        <div class="form-inline">
            <div class="col-md-3">
                <div class="jumbotron" style="background-color: rgb(218, 68, 83)"
                     align="center">
                    <p style="font-size: 28px; font-weight: 700; color: white;">การแก้ไขบัญชีบัญชียา</p>
                </div>
            </div>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <table class="table table-striped table-hover  table-bordered">
                ...
                <tr align="center">
                    <td><%=i++%></td>
                    <td>${list.medicineEntity.tradeName }</td>
                    <td>ยา/วิตามินแร่ธาตุ</td>
                    <td>${list.quantity }</td>
                    <td>${list.medicineEntity.unitMedicineEntity.value }</td>
                    <td>${list.price }</td>
                    <td><fmt:formatDate value="${Day}" pattern="dd-MM-yyyy"/></td>
                    <td>
                        <a href="/farm3/modify_medicine"<%--/${datamedicine.id}--%>">
