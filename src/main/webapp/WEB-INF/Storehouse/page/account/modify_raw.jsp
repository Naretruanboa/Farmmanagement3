...
<title>การแก้ไขบัญชีวัตถุดิบ</title>
		...
		<div class="row form-group">
			<div class="col-md-3">
				<div class="jumbotron" style="background-color: rgb(218, 68, 83)"
					align="center">
					<p style="font-size: 28px; font-weight: 700; color: white;">การแก้ไขบัญชีวัตถุดิบ</p>
				</div>
			</div>
		</div>
				...
				<div class="row form-group">
					...
					<div class="col-md-6"> <!-- คอลัมแรก -->
						...
						<div class="row form-group">
								...
								<label class="col-md-offset-1 col-md-3 control-label"> ชื่อวัตถุดิบ</label>
								<div class="col-md-6">
						...
						<div class="row form-group">
								...
								<label class="col-md-offset-1 col-md-3 control-label"> หน่วย</label>
								<div class="col-md-6">
