				...
				<form action="imported_semen" method="POST"  id="semen">
					...
					<div class="row form-group">
						...
						<div class="col-md-6"> <!-- คอลัมแรก -->
							<div class="row form-group">
								<label  class="col-md-offset-0 col-md-4 control-label"> วันที่นำเข้า</label>
								<div class="col-md-3">
							...
							<div class="row form-group">
									...
									<label class="col-md-offset-0 col-md-4 control-label"> ชื่อน้ำเชื้อ/พ่อพันธุ์</label>
									<div class="col-md-6">
							...
							<%--<div class="row form-group">
									...
									<label class="col-md-offset-0 col-md-4 control-label">จำนวนคงคลัง</label>
									<div class="col-md-6">
							...
							<div class="row form-group">
								<label  class="col-md-offset-0 col-md-4 control-label">ลอต</label>
								<div class="col-md-6">
						...
						<div class="col-md-6 "> <!-- คอลัม2 -->
							...
							<div class="row form-group">
								<label  class="col-md-offset-1 col-md-3 control-label">จำนวนที่นำเข้า</label>
								<div class="col-md-6">
									<div class="input-group">
							...
							<div class="row form-group">
								<label  class="col-md-offset-1 col-md-3 control-label">ผลิต/นำเข้า</label>
								<div class="col-md-6">
							...
							<div class="row form-group">
								<label class="col-md-offset-1 col-md-3 control-label">ราคารวม</label>
