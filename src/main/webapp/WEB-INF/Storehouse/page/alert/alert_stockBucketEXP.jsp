...
<%int i=1,n=1,m=1,o=1,p=1,q=1,r=1; %>
		...
		<div class="col-md-3">
                ...
                <li ><a href="alert"><font size="4"> ยาคงคลัง</font></a></li><br>
                ...
                <li class="active"><a href="alert?id=7" ><font size="4">ปริมาณไนโตรเจนเหลวต่ำกว่ากำหนด</font></a></li>
              </ul>
				</div>
			</div>
		</div>
              ...
              <form id="closealert">  
				...
				<thead>
					...
					<tr>
						...
						<th align="center">รหัสถัง</th>
				        <th align="center">ชื่อถัง</th>
				        <th align="center">วันที่ควรเติมไนโตรเจนเหลวใหม่</th>
...
$("#list").load('alert_stockBucketEXP',function(){
...
$(document).on('click','#pageNum',function(e){
	 ...
	 $("#list").load('alert_stockBucketEXP',{ page:$("[id=pageNum]").eq(id).val()},function(){
			$("#page").load('page',{ pagePresent : $("#Page").val(), pageLast : $("#countPage").val()},function(m){
				for(i=0 ;i<=8;i++){
					if($("[id=pageNum]").eq(i).val()==$("#Page").val()){
						$("[id=pageNum]").eq(i).addClass("active");
