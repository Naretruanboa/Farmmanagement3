...
<div class="container-fluid">
	...
	<div class="navbar-header">
		<a class="navbar-brand" href="index"><img
			src="<c:url value=  "resources/img/Nutrient/b2.png"/> "
			height="40"></a>
		...
		<!--admin -->
            <c:if test="${m.privilege.id==1 }">
              <ul class="nav navbar-nav">
				...
				<li><a href="alertfood"><i class="fa fa-exclamation-triangle"></i> แจ้งเตือน</a></li>

				<li class="dropdown"  style="width: auto;height: auto">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-cogs"></i> ตั้งค่า<b class="caret"></b></a>
					<ul class="dropdown-menu">
						<li><a href="SetMemberNutrientSystem"><i class="fa fa-file-text"></i> ตั้งค่าข้อมูลสมาชิก</a></li>
						...
						<li><a href="SetrawmaterialnutrientNutrientSystem"><i class="fa fa-file-text"></i> ตั้งค่าข้อมูลทางโภชนะของวัตถุดิบ</a></li>
						<li><a href="set_alert_nutrinet"><i class="fa fa-file-text"></i> ตั้งค่าการแจ้งเตือน</a></li>
						<li><a href="set_unit_nutrinet"><i class="fa fa-file-text"></i> ตั้งค่าหน่วยของวัตถุดิบที่ใช้</a></li>
						
					</ul>
				</li>

				<li><a href="<c:url value= "/resources/img/Nutrient/guide2.pdf" />" target=_blank><img
