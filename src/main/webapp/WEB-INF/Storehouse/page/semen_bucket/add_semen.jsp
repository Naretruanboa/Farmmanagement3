		...
		<div class="row form-group"> <!-- //ตาราง -->
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h4 class="panel-title"><span class="fa fa-list-alt fa-lg"></span>&nbsp;ข้อมูลน้ำเชื้อ</h4>
				</div>
		...
		function(isConfirm){   
			if (isConfirm) {
				...
				if($("#nameCattle").val()  == ""){
					...
					$.post('chkSemen',{namecattle:$("#nameCattle").val()},function(msg){
						if(msg=="yes"){
				...
				$.post('addsemen',$("#semen").serialize(),
				      function (result) {
						...
						else{swal("ผิดพลาด", "ชื่อพ่อพันธุ์ซ้ำ!", "error");}
					}) //end post
				}
				} else { 
