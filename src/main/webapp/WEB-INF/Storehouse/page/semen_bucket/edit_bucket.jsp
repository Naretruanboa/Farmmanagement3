...
<title>แก้ไขข้อมูลถังเก็บน้ำเชื้อ/ถังเก็บไนโตรเจนเหลว</title>
</head>
<body>
...
<div class="container">
		<div class="col-md-3">
				...
				<p style="font-size: 28px; font-weight: 700; color: white;">แก้ไขข้อมูลถัง</p>
			</div>
		</div>
		<br><br><br>
		...
		<div class="row form-group"><!-- //ตารางบน -->
			<div class="panel panel-primary">
				...
				<form:form action="edited_bucket" method="POST"  id="bucket" modelAttribute="bucket"  commandName="bucket" >
			...
			<!-- 	*********************************************ตารางด้านใน******************************************** -->
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							...
							<div class="row form-inline ">
								...
								<div class="col-md-6">							 		
							 		<form:input type="number" class="form-control" id="ratioNitrogen" path="ratioNitrogen" size="15"/>																							
								</div>
							</div>
				...
				<div class="col-md-offset-9">
									<button name="action" value="edit" id="edit" onclick="editbucket()"
	...
	swal({	title: "ยืนยันบันทึกข้อมูล?",   
		...
		function(isConfirm){   
			if (isConfirm) {
				...
				$.post('edited_bucket',$("#bucket").serialize(),
				      function (result) {
						...
						function(){   
							window.location.href='view_bucket'; 
							});
