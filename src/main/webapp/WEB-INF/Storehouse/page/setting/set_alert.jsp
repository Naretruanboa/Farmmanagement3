...
<hr>
		...
		<div class="col-md-4"> <!-- //colum1 -->
				...
				<div class="col-md-12">
					<div class="panel panel-primary">
						<div class="panel-heading">
						 	<h4 class="panel-title" style="font-size: 25px;"><i class="fa fa-calendar"></i>&nbsp;ยา</h4>
						</div>
							...
							<div class="row form-group">
								<div class="col-md-offset-0 col-md-12">
									<div class="form-inline">
										...
										<form:input path="stockMedicine" type="number" class="form-control input-sm " size="15" />
							...
							<div class="row form-group">
								<div class="col-md-offset-0 col-md-12">
									<div class="form-inline">
										...
										<form:input path="expMedicine" type="number"
			...
			<div class="row form-group">
				<div class="col-md-12">
					<div class="panel panel-primary">
						<div class="panel-heading">
						 	<h4 class="panel-title" style="font-size: 25px;"><i class="fa fa-calendar"></i>&nbsp;น้ำเชื้อ</h4>
						</div>
						<div class="panel-body">
							<!-- <h1>HI</h1> -->
							<div class="row form-group">
								<div class="col-md-offset-0 col-md-12">
									<div class="form-inline">
										<label class="control-label">เมื่อยอดคงคลังน้อยกว่า </label>
										<form:input path="stockSemen" type="number" class="form-control input-sm " size="15"/>
										<label class="control-label">หน่วย </label>
		...
		<div class="col-md-4"><!-- //colum2 -->
			...
			<div class="row form-group">
				<div class="col-md-12">
					<div class="panel panel-primary">
						<div class="panel-heading">
						 	<h4 class="panel-title" style="font-size: 25px;"><i class="fa fa-calendar"></i>&nbsp;ถังเก็บน้ำเชื้อ</h4>
						</div>
						<div class="panel-body">
							<!-- <h1>HI</h1> -->
							<div class="row form-group">
								<div class="col-md-offset-0 col-md-12">
									<div class="form-inline">
										<label class="control-label">แจ้งเตือนล่วงหน้า </label>
										<form:input path="expBucket" type="number"
										class="form-control input-sm " size="16"/>
										<label class="control-label">วัน </label>
									</div>
								</div>
		...
		<div class="col-md-4">	<!-- //colum3-->
			<div class="row form-group">
				<div class="col-md-12">
					<div class="panel panel-primary">
						<div class="panel-heading">
						 	<h4 class="panel-title" style="font-size: 25px;"><i class="fa fa-calendar"></i>&nbsp;วัสดุ/อุปกรณ์</h4>
						</div>
						<div class="panel-body">
							<div class="row form-group">
								<div class="col-md-offset-0 col-md-12">
									<div class="form-inline">
										<label class="control-label">เมื่อยอดคงคลังน้อยกว่า </label>
										<form:input path="stockTool" type="number" class="form-control input-sm " size="15"/>
										<label class="control-label">หน่วย </label>
...
function setedalert(){
	...
	swal({	title: "ยืนยันบันทึกข้อมูล?",   
		...
		function(isConfirm){   
			if (isConfirm) {
				if($("#stockMedicine").val() == "" || $("#stockMedicine").val() < 0){
					swal("กรุณากรอกจำนวนให้ถูกต้อง");
				}else if($("#expMedicine").val() == "" || $("#expMedicine").val() < 0){
					swal("กรุณากรอกวันแจ้งเตือนล่วงหน้าให้ถูกต้องให้ถูกต้อง");
				}else if($("#stockRaw").val() == "" || $("#stockRaw").val() < 0){
					swal("กรุณากรอกจำนวนให้ถูกต้อง");
				}else if($("#expRaw").val() == "" || $("#expRaw").val() < 0){
					swal("กรุณากรอกวันแจ้งเตือนล่วงหน้าให้ถูกต้องให้ถูกต้อง");
				}else if($("#stockTool").val() == "" || $("#stockTool").val() < 0){
					swal("กรุณากรอกจำนวนให้ถูกต้อง");
				}else if($("#stockSemen").val() == "" || $("#stockSemen").val() < 0){
					swal("กรุณากรอกจำนวนให้ถูกต้อง");
				}else if($("#expBucket").val() == "" || $("#expBucket").val() < 0){
					swal("กรุณากรอกวันแจ้งเตือนล่วงหน้าให้ถูกต้องให้ถูกต้อง");
				}else{
