...
<html>
<head>
<title>ตั้งค่าหมวดหมู่วัสดุอุปกรณ์</title>
<style>
ul#myTab1 li {
				...
				<div class="form-inline">
					<div class="col-md-3">
						<div class="jumbotron" style="background-color: rgb(218, 68, 83)"
							align="center">
							<p style="font-size: 28px; font-weight: 700; color: white;">การตั้งค่าหมวดหมู่วัสดุอุปกรณ์</p>
						</div>
					</div>	
				</div>
		</div>
             	...
             	<div class="tab-pane fade active in" id="breed">
             	 	...
             	 	<div class="example">
        					...
        					<div class="col-md-6">
        						<div class="panel panel-primary">
        							<div class="panel-heading">
        								<h3 class="panel-title">เพิ่มหมวดหมู่</h3>
        							</div>
        							<div class="panel-body">
        								<table >
        									...
        									<tr>
        										<td><h4>ชื่อหมวดหมู่ : </h4></td>
        										<td>
        										<form:form commandName="addTypeTool" id="addTypeTool" >
          				...
          				<div class="col-md-6">
           				 <div class="panel panel-primary">
             				 <div class="panel-heading">
                				<h3 class="panel-title">หมวดหมู่ที่มีอยู่</h3>
             				 </div>
             				 <table class="table table-striped table-hover  table-bordered">
									<thead>
										<tr>
				    						<th align="center">ชื่อหมวดหมู่</th>
				       				 		<th align="center">ลบ</th>
				   		   				</tr>
				 		   		</thead>
						    		<tbody style="text-align: center;">
						   	 		<c:forEach items="${typetool }" var="t">
						     			<tr>	
						      				<td>${t.value }</td>
						        			<td>
...
$(document).on('click','#add',function(e){
	...
	if(value=="")
	{
		swal("ผิดพลาด", "กรอกชื่อหมวดหมู่ให้ถูกต้อง!", "error");
		
	}
	else
	{
		$.post('chkTypeTool',{unit:$("#value").val()},function(msg){
			if(msg=="yes"){
				$.ajax({
					url:"addTypeTool",
					method:"POST",
					data:$("#addTypeTool").serialize()
				}).done(function(s){
					swal({  title: "สำเร็จ",   
