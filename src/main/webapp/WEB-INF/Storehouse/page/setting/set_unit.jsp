				...
				<div class="form-inline">
					<div class="col-md-3">
						<div class="jumbotron" style="background-color: rgb(218, 68, 83)"
							align="center">
							<p style="font-size: 28px; font-weight: 700; color: white;">การตั้งค่าหน่วยที่ใช้ในคลัง</p>
						</div>
					</div>	
				</div>
		</div>
          ...
          <div class="col-md-10">
           	<div class="panel">
              	<ul id="myTab1" class="nav nav-pills nav-justified">
                	<li class="active"><a href="#medicine" data-toggle="tab" style="display:block;" ><font size="5">หน่วยของยา </font></a></li>
               	 	<li><a href="#raw" data-toggle="tab" style="display:inline-block width:10%; , line-height: 70%; "><font size="5">หน่วยของวัตถุดิบ</font></a></li>
                	 <li><a  href="#tool" data-toggle="tab" style="display:block;"><font size="5">หน่วยของวัสดุ/อุปกรณ์</font></a></li>
             	...
             	<div class="tab-pane fade active in" id="medicine">
             	 	...
             	 	<div class="example">
        					...
        					<div class="col-md-6">
        						<div class="panel panel-primary">
        							<div class="panel-heading">
        								<h3 class="panel-title">เพิ่มหน่วยยาที่ใช้ในคลัง</h3>
        							</div>
        							<div class="panel-body">
        								<table >
        									...
        									<tr>
        										<td><h4>หน่วยยา : </h4></td>
        										<td>
        										<form:form commandName="Unitmedicine" id="unitMedicine" >
        											<form:input  id="unitmed" path = "value" class="form-control2 col-md-offset-1"  />
        										</form:form>
												</td>
        										<td>
        											
        											<button type="button" class="btn btn-success col-md-offset-12" id="saveUnitmedicine">
          				...
          				<div class="col-md-6">
           				 <div class="panel panel-primary">
             				 <div class="panel-heading">
                				<h3 class="panel-title">หน่วยของยาที่ใช้อยู่</h3>
             				 </div>
             				 <table class="table table-striped table-hover  table-bordered">
						    		...
						    		<tbody style="text-align: center;">
						   	 		<c:forEach items="${unitmedicine }" var="unitm">
						     			<tr>	
						      				<td>${unitm.value }</td>
						        			<td>
						        			<%--  onclick="onClickDeleteGen('${unitm.id}')" --%>
				 			       				<%-- <div align="center"><a href="del_unit_medicine?id=${unitm.id}" >
				 			       						<button type="button" class="btn btn-danger">
			     		   								<span class="glyphicon glyphicon-floppy-remove"></span></button></a>
		        								</div> --%>
		        								<button class="btn btn-danger"
												value="${unitm.id}" onclick="chkdelUMED(this.value)">
												<span class="glyphicon glyphicon-floppy-remove"></span>
											</button>
											
		        								<%-- <form:form action="del_unit_medicine?id=${unitm.id}" method="POST" commandName="show">
											
											<button name="action" type="submit" id="del_unit_medicine" class="btn btn-danger"
             	 	...
             	 	<div class="example">
      					<div class="row ">
        					<div class="col-md-6">
        						<div class="panel panel-primary">
        							<div class="panel-heading">
        								<h3 class="panel-title">เพิ่มหน่วยวัสดุและอุปกรณ์ที่ใช้ในคลัง</h3>
        							</div>
        							<div class="panel-body">
        								<table >
        									<tbody align="center">
        									...
        									<tr>
        										<td><h5>หน่วยวัสดุอุปกรณ์ : </h5></td>
        										<td>
        										<form:form commandName="Unittool" id="Unittool" >
        											<form:input  id="unitool" path = "value" class="form-control2 col-md-offset-1"  />
        										</form:form>
												</td>
        										<td>
        											
        											<button type="button" class="btn btn-success col-md-offset-12" id="saveUnittool">
				        								<span class="glyphicon glyphicon-floppy-saved"></span></button>
          				...
          				<div class="col-md-6">
           				 <div class="panel panel-primary">
             				 <div class="panel-heading">
                				<h3 class="panel-title">หน่วยของวัสดุและอุปกรณ์ที่ใช้อยู่</h3>
             				 </div>
             				 <table class="table table-striped table-hover  table-bordered">
									<thead>
										<tr>
						    		...
						    		<tbody style="text-align: center;">
						   	 		<c:forEach items="${unittool }" var="unitt">
						     			<tr>	
						      				<td>${unitt.value }</td>
						        			<td>
						        			
		        								<button class="btn btn-danger"
												value="${unitt.id}" onclick="chkdelUTOOL(this.value)">
												<span class="glyphicon glyphicon-floppy-remove"></span>
											</button>
		        								<%-- <form:form action="del_unit_tool?id=${unitt.id}" method="POST" commandName="show">
												
														<button name="action" type="submit" id="del_unit_tool" class="btn btn-danger"
															onclick="return confirm('Do you want to delete?')">
															<span class="glyphicon glyphicon-floppy-remove"></span>
														</button>
