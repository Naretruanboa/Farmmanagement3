...
<div class="panel panel-primary">
	...
	<form:form action="edited_member" method="post" commandName="member" id="member">
		<form:input path="id" type="hidden"/>
		<form:input path="question" id="question" type="hidden"/>
		<form:input path="answer" id="answer" type="hidden"/>
	...
	<tr>
		<th class="text-center">กำหนดสิทธิ์การใช้งาน</th>
		<td class="text-center">
	...
	<tr>
		...
		<form:input type="hidden" path="privilege.id" class="form-control"/>
					...
					<button type="submit" id="edit" class="btn btn-embossed btn-success btn-wide" style="text-align: center;">บันทึก</button>
					<a href="set_member"><button type="submit" id="cancle" name="action" class="btn btn-embossed btn-danger btn-wide" style="text-align: center;">ยกเลิก</button></a>
					</div>
			...
			$.ajax({
				...
				swal({  title: "สำเร็จ",   
					text: "บันทึกเรียบร้อยแล้ว!", 
						...
						function(){   
							window.location.href='set_member'; 
							});
