				...
				<br>
					...
					<div class="panel-heading">
						<h4 class="panel-title">
							<span class="fa fa-list-alt fa-lg"></span> ข้อมูลโค
						</h4>
					</div>
					<%
						int i = 0;
						...
						<table class="table table-striped table-hover  table-bordered"
							...
							<thead>
								<tr>
									...
									<th style="width: 250px;">ประเภทโค</th>
									<th style="width: 190px;">สายพันธุ์</th>
									<th style="width: 190px;">ดูรายละเอียดโค</th>
									<th style="width: 190px;">ดูรายละเอียดการรักษา</th>
									<th style="width: 190px;">ดูรายละเอียดใบพันธุ์ประวัติโค</th>
...
$("#listM").load('search_cattle',{ id : 0 ,value : 0},function(){ //load list_view_medicine
