...
<div class="container">
		<div class="col-md-3">
			<div class="jumbotron" style="background-color: rgb(218, 68, 83)" align="center">
				<p style="font-size: 28px; font-weight: 700; color: white;">ติดตามการรักษา</p>						
			</div>		
		</div>
	<div class="row">
		<hr>
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h4 class="panel-title">
					<span class="fa fa-list-alt fa-lg"></span> ติดตามการรักษา</a>
				</h4>
			</div>
				...
				<div class="row form-group">
					<div class="col-md-8">
						<fieldset><br>
								...
								<%-- listtype_health() --%>
												<div class="row form-group">
													<label class="col-md-offset-s col-md-3 control-lable"><font color="red">* </font>ประเภทการติดตามการรักษา</label>
													<div class="col-md-6">
													<div>
													<select class="form-control typeHealth " id="typeHealth" name="type_health" onchange="ListTypeHealth();">
															<option value="0">เลือกประเภทการติดตามการรักษา</option>
															<c:forEach items="${typeHealth }" var="typeH">
													
															<option value="${typeH.id }" >&nbsp;${typeH.value }</option>
													</c:forEach>
													</select>
													</div>
													</div>
...
<script type="text/javascript">
function ListTypeHealth(){
	var selectedValue = $(".typeHealth").val();  //หลังclass form control
	//alert(selectedValue);
	if(selectedValue != 0){
	$.ajax({
		  url: "listTypeHealth",
