...
<title>รายละเอียดข้อมูลโรค</title>
</head>
<body>
			...
			<div class="container">
				<div class="col-md-3">
					<div class="jumbotron" style="background-color: rgb(218, 68, 83)"
						align="center">
						<p style="font-size: 28px; font-weight: 700; color: white;">รายละเอียดข้อมูลโรค</p>
					</div>
				</div>
				<div class="row">
					<hr>
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						...
						<span class="fa fa-list-alt fa-lg"></span> รายละเอียดข้อมูลโรค</a>
						</h4>
				</div>
