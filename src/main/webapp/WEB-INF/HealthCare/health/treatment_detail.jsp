...
<title>บันทึกการให้ยาและรักษาโรค</title>
	...
	<div class="container">
		<div class="col-md-3">
			<div class="jumbotron" style="background-color: rgb(218, 68, 83)" align="center">
				<p style="font-size: 28px; font-weight: 700; color: white;">บันทึกการให้ยาและรักษาโรค</p>						
			</div>		
		</div>
	<div class="row">
		<hr>
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h4 class="panel-title">
					<span class="fa fa-list-alt fa-lg"></span> บันทึกการให้ยาและรักษาโรค</a>
				</h4>
			</div>
					...
					<div class="row form-group">
						<div class="col-md-6"> 
							<fieldset><br>
								...
								<div class="row form-group">
									<label class="col-md-offset-s col-md-3 control-label"><font color="red">*</font> วันที่วินิจฉัย</label>
									<div class="col-md-6">
										...
										<div class="row form-group">
											<label class="col-md-offset-s col-md-3 control-lable"><font color="red">* </font>เวลาที่วินิจฉัย</label>
											<div class="col-md-6">
