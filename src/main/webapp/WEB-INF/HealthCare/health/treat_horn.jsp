...
<title>ติดตามการรักษาหลังสูญเขา</title>
	...
	/* function annconf() {
		...
		var vfullearly2 = document.getElementById('statusmedicine').value;
		document.getElementById('causeOfIllness').disabled=true;
		document.getElementById('statusmedicine').disabled=true;
		document.getElementById('disease').disabled=true;
		 document.getElementById('symptomsOfDisease').disabled=true; 
        ...
        document.getElementById('doseUsesage5').disabled=true;
    		...
    		document.getElementById('causeOfIllness').disabled=false;
    		document.getElementById('statusmedicine').disabled=false;
...
<div class="container">
		<div class="col-md-3">
			<div class="jumbotron" style="background-color: rgb(218, 68, 83)" align="center">
				<p style="font-size: 28px; font-weight: 700; color: white;">ติดตามการรักษาหลังสูญเขา</p>						
			</div>		
		</div>
	<div class="row">
		<hr>
						...
						<fieldset><br>
										...
										<input name="num" id="num" type="text" class="form-control" disabled="disabled"/>
												...
												<div class="row form-group">
													...
													<div class="col-md-6">
														...
														<div class="row form-group">
															<label class="col-md-offset-s col-md-3 control-lable"><font color="red">* </font>เวลาติดตามการรักษา</label>
															<div class="col-md-6">
								...
								<div class="col-md-4">
											<fieldset><br>
										 		...
										 		<div class="row form-group"> 
													<label class="col-md-offset-s col-md-4 control-label"><font color="red">* </font>อาการเจ็บป่วย</label>
													<div class="col-md-6">
														<textarea rows="3" cols="45" name="causeOfIllness" id="causeOfIllness" type="text" class="form-control"></textarea> 
													</div>
												</div>
											<div class="row form-group"> 
													<label class="col-md-offset-s col-md-4 control-label"><font color="red">* </font>วิธีการรักษา</label>
													<div class="col-md-6">
														<textarea rows="3" cols="45" name="hornRemedy" id="hornRemedy" type="text" class="form-control"></textarea> 
													</div>
											</div>  
												
												
												<div class="row form-group">
												<label class="col-md-offset-s col-md-4 control-label"><font color="red">* </font> ผู้บันทึก</label>
												<div class="col-md-6">
											 		<div>
													<select class="form-control" id="memberid" name="memberid">
														...
														<div class="row form-group">
															<label class="col-md-offset-s col-md-4 control-lable"><font color="red">* </font>แจ้งเตือนการรักษา</label>
															<div class="col-md-6">
							...
							<fieldset><br>
<!-- 								<div class="row form-group">
									<label class="col-md-offset-s col-md-3 control-label"><font color="red">* </font> สถานะการรักษา</label>
									<div class="col-md-6">
								 		<div>
											<select  id="statusTreat" name="statusTreat" class="form-control select select-info" data-toggle="select" onchange="annconf(this.value);">
...
function listcattle1() { //เอาหน่วยที่ใช้ในคลังอออกมา
