		...
		<div id="content">
			<div class="container">
				...
				<div class="panel-body">
							<form:form action="disease_edited" method="POST"  id="disease"
							modelAttribute="disease"  commandName="disease" >
							 	...
							 	<div>
									<form:select class="form-control" id="cableDisease.id" path="cableDisease.id">
										<form:option value="0">ประเภทของโรค</form:option>
												<c:forEach items="${calble}" var="calbledis">
						...
						<div class="col-md-6">
							...
							<div class="row form-group">
								...
								<div class="col-md-offset-8">
									...
									<a href="diseasesh"><button name="action" value="cancel" onclick="cancel()"
		...
		swal({	title: "ยืนยันบันทึกข้อมูล?",   
			...
			function(isConfirm){   
				if (isConfirm) {
					...
					$.post('disease_edited',$("#disease").serialize(),
					      function (result) {
					     	swal({	title: "Success!",   
								...
								function(){   
									window.location.href='diseasesh'; 
							});
