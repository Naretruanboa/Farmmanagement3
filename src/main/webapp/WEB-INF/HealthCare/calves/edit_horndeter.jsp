...
<title>แก้ไขข้อมูลการหย่านม</title>
</head>
<body>
			...
			<div class="container">
				<div class="col-md-3">
					<div class="jumbotron" style="background-color: rgb(218, 68, 83)"
						align="center">
						<p style="font-size: 28px; font-weight: 700; color: white;">แก้ไขข้อมูลการหย่านม</p>
					</div>
				</div>
				<div class="row">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						...
						<span class="fa fa-list-alt fa-lg"></span>&nbsp;ข้อมูลการหย่านม</a>
						</h4>
				</div>
								...
								<fieldset><br>
										<div class="row form-group">
											<label class="col-md-offset-s col-md-3 control-lable"><font color="red">* </font> วิธีที่ใช้ในการสูญเขา</label>
												<div class="col-md-6">
							 						<div>
														<select class="form-control" id="typehorn.id" name="typehorn.id">
															<option value="">เลือกรายการ</option>
															<c:forEach items="${typehorn }" var="typehorn">
																<option value="${typehorn.id }">&nbsp;${typehorn.value }</option>														
															</c:forEach>
														</select>
							 						</div>																				
													<!-- <input path="" id="" type="text" class="form-control"/> -->
