...
<div class="container-fluid">
 <div class="navbar-header">
   <a class="navbar-brand" href="index"><img
     src="<c:url value=  "resources/img/Logo-V10.png"/> "
 ...
 <li class="dropdown" role="menu">
        ...
        <c:if test="${sessionScope.privilege == 1 || sessionScope.privilege == 2}">
               <li><a tabindex="-1" href="treat"><i class="fa fa-pencil-square-o fa-fw"></i>บันทึกการให้ยาและรักษาโรค</a></li>
        </c:if>
        <c:if test="${sessionScope.privilege == 1 || sessionScope.privilege ==2 || sessionScope.privilege ==3}">
        					<li ><a tabindex="-1" href="list_recommend"><i class="fa fa-search"></i> แนะนำการให้ยา</a></li>
        		 			<li ><a tabindex="-1" href="disease"><i class="fa fa-pencil-square-o fa-fw"></i>บันทึกข้อมูลโรค</a></li>
          					<li ><a tabindex="-1" href="treat_health"><i class="fa fa-pencil-square-o fa-fw"></i>บันทึกข้อมูลติดตามการรักษา</a></li> 
...
<%--          <c:if test="${sessionScope.privilege == 1 || sessionScope.privilege == 2}">
             ...
             <li class="dropdown-submenu" role="menu">
                     <a tabindex="-1" href="#"><i class="fa fa-table fa-fw"></i>ประวัติการรักษาและข้อมูลโรคเบื้องต้น</a>
                     <ul class="dropdown-menu">
                        <li><a tabindex="-1" href="treat_his_list"><i class="fa fa-table fa-fw"></i>ประวัติการรักษา</a></li>
       ...
       <li class="dropdown" role="menu">
             ...
             <ul class="dropdown-menu">
          <c:if test="${sessionScope.privilege == 1 || sessionScope.privilege ==2 || sessionScope.privilege ==3}">
               <li><a tabindex="-1" href="add_medicineH"><i class="fa fa-pencil-square-o fa-fw"></i>ลงทะเบียนยาใหม่</a></li>
               <!-- <li><a tabindex="-1" href="import_medicine"><i class="fa fa-pencil-square-o fa-fw"></i>นำเข้ายา</a></li> -->
               <li><a tabindex="-1" href="release_medicineH"><i class="fa fa-pencil-square-o fa-fw"></i>เบิกยา</a></li>
...
<li class="dropdown" role="menu">
						<a tabindex="-1" href="view_semen_Health" class="dropdown-toggle" data-toggle="dropdown"><img
						...
						<ul class="dropdown-menu">
                            ...
                            <li><a tabindex="-1" order_semen="" href="order_semen"><i class="fa fa-pencil-square-o fa-fw"></i>สั่งซื้อน้ำเชื้อ</a></li>
							<li><a tabindex="-1" href="view_semen_Health"><i class="fa fa-pencil-square-o fa-fw"></i>การเบิกน้ำเชื้อ</a></li>
...
<li class="dropdown" role="menu">
						...
						<ul class="dropdown-menu">
							<li ><a tabindex="-1" href="misscarry"><i class="fa fa-pencil-square-o fa-fw"></i>บันทึกข้อมูลโคแท้ง</a></li>
							<li><a tabindex="-1" href="misscarry_listG"><i class="fa fa-table fa-fw"></i>ข้อมูลโคแท้ง</a></li>
						</ul>
					</li>
     <li class="dropdown" role="menu">
             ...
             <li class="dropdown-submenu" role="menu">
                    ...
                    <li><a tabindex="-1" href="weight_listH1"><i class="fa fa-table fa-fw"></i>ข้อมูลน้ำหนัก 1 ปี</a></li>
                     </ul>
                 </li>
             </ul>
     </li>
      ...
      <c:if test="${sessionScope.privilege == 1 || sessionScope.privilege ==2 || sessionScope.privilege ==3}">
       <li class="dropdown">
               <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-cogs"></i> ตั้งค่า <b class="caret"></b></a>
                 <ul class="dropdown-menu">
                   <li	><a href="set_alertH">ตั้งค่าการแจ้งเตือน</a></li>
                   <li	><a href="set_sync">ตั้งค่าการเหนี่ยวนำ</a></li>
                   <li	><a href="set_brandH">ตั้งค่าแบรนด์</a></li>
                   <c:if test="${sessionScope.privilege == 1}">
                 <li><a href="set_memberH">จัดการข้อมูลสมาชิก</a></li>
               </c:if>
                <!--    <li class="divider"></li> -->
                   <li class="dropdown-submenu" role="menu">
                        ...
                        <li><a tabindex="-1" href="set_stall">ตั้งค่าคอกโค</a></li>
