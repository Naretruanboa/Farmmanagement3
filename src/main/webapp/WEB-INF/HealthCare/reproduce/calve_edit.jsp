...
<title>แก้ไขข้อมูลการคลอด</title>
...
<div class="container">
			<div class="col-md-3">
				<div class="jumbotron" style="background-color: rgb(218, 68, 83)"
						align="center">
						<p style="font-size: 28px; font-weight: 700; color: white;">แก้ไขข้อมูลการคลอด</p>
				</div>	
			</div>
			<div class="row">
				<hr>
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h4 class="panel-title">
							<span class="fa fa-list-alt fa-lg"></span> แก้ไขข้อมูลการคลอด</a>
						</h4>
					</div>
