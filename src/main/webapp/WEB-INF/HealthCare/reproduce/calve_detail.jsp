...
<div class="container">
			<div class="col-md-3">
				<div class="jumbotron" style="background-color: rgb(218, 68, 83)"
						align="center">
						<p style="font-size: 28px; font-weight: 700; color: white;">ข้อมูลการคลอด</p>
				</div>	
			</div>
			<div class="row">
				<hr>
								...
								<div class="col-md-6">
									<fieldset><br>
											...
											<label class="col-md-offset-s col-md-3 control-lable"><font color="red">* </font> หมายเลขแม่พันธุ์</label>
												<div class="col-md-6">
							 						<div>
														...
														<input value="${catn.maId }" type="text" class="form-control" readonly style="background-color:#e4ecf7"/> 
										...
										<div class="row form-group">
											...
											<div class="col-md-6">
												<input  value="${catn.calved }"  class="form-control" readonly style="background-color:#e4ecf7"/>
											</div>
										</div>	
								...
								<div class="col-md-6">
											...
											<label class="col-md-offset-s col-md-3 control-lable"><font color="red">* </font> หมายเลขพ่อพันธุ์  </label>
												<div class="col-md-6">
													...
													<%-- <select class="form-control" id="fatcatl" name="fatcatl">
														...
														<input value="${catn.faId }" type="text" class="form-control" readonly style="background-color:#e4ecf7"/> 
							 						</div>																				
									...
									<div class="row form-group">
											...
											<!-- 	<div class="col-md-6">
												...
												<input value="${catn.statusBorn.value }" type="text" class="form-control" readonly style="background-color:#e4ecf7"/> 
										</div>	
							...
							<div class="panel panel-primary" >
								...
								<fieldset id="field1">
									<div class="row form-group">
										...
										<div class="col-md-6">
											<input value="${catn.numDate }" type="text" class="form-control" readonly style="background-color:#e4ecf7"/>
										</div>
									</div>
									...
									<div class="row form-group">
										...
										<div class="col-md-6">
											<input name="name" id="name" value="${catn.name }" type="text" class="form-control" readonly style="background-color:#e4ecf7"/>
										</div>
									</div>		
									...
									<div class="row form-group">
										...
										<div class="col-md-6">
									 		<div>
									 		<input name="name" id="name" value="${catn.breed.value }" type="text" class="form-control" readonly style="background-color:#e4ecf7"/>
									...
									<div class="row form-group">
										...
										<div class="col-md-6">
									 		<div>
												...
												<input value="${catn.color.value }" type="text" class="form-control" readonly style="background-color:#e4ecf7"/>
									 		</div>											
										</div>
									</div>	
									...
									<div class="row form-group">
										...
										<div class="col-md-6">
									 		<div>
												...
												<input value="${catn.sex.value }" type="text" class="form-control" readonly style="background-color:#e4ecf7" />
									 		</div>											
										</div>
									</div>																				
									...
									<%-- 											
									<div class="row form-group">
										<label class="col-md-offset-s col-md-3 control-label"><font color="red">* </font>น้ำหนักแรกเกิด</label>
										<div class="col-md-6">
											<div class="input-group">
												<input name="weightBirth" id="weightBirth" value="${catn.weightBirth }" type="text" class="form-control" />
									 ...
									 <div class="row form-group">
										...
										<div class="col-md-6">
									 		<div>
												...
												<input value="${catn.weightBirth }" type="text" readonly style="background-color:#e4ecf7"   class="form-control" />
												 <span class="input-group-addon" style="border-radius: 0px 10px 10px 0px;">กก.</span>
												 </div>
									 		</div>											
										</div>
								...
								<div class="col-md-offset-8 col-md-6">
									<a href=calve_list><button type="button" class="btn btn-embossed btn-primary">
