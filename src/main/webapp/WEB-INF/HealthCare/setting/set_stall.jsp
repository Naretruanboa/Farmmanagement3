	...
	<div class="container">
								...
								<div class="form-inline">
									<div class="col-md-3">
										<div class="jumbotron" style="background-color: rgb(218, 68, 83)"
											align="center">
											<p style="font-size: 28px; font-weight: 700; color: white;">การตั้งค่าคอก</p>
										</div>
									</div>	
								</div>
						</div>
						...
						<div class="row ">
        					<div class="col-md-6">
        						<div class="panel panel-primary">
        							<div class="panel-heading">
        								<h3 class="panel-title">เพิ่มคอก</h3>
        							</div>
        							<div class="panel-body">
        								<table >
        									...
        									<tr>
        										<td><h4>คอก: </h4></td>
        										<td>
        										<form:form commandName="statbstall" id="statbstall" >
          				...
          				<div class="col-md-6">
           				 <div class="panel panel-primary">
             				 <div class="panel-heading">
                				<h3 class="panel-title">คอกที่มี</h3>
             				 </div>
             				 <table class="table table-striped table-hover  table-bordered">
									<thead>
										<tr>
				    						<th align="center">คอก</th>
						    		...
						    		<tbody style="text-align: center;">
						   	 		<c:forEach items="${stat_stall }" var="statS">
						     			<tr>	
						      				<td>${statS.value }</td>
						        			<td>
		        								<button class="btn btn-danger"
												value="${statS.id}" onclick="chkdel(this.value)">
...
$(document).on('click','#add',function(e){
	...
	if(value=="")
	{
		swal("ผิดพลาด", "กรอกชื่อคอกให้ถูกต้อง!", "error");
		
	}
	else
	{
		$.post('Checkstall',{value:$("#value").val()},function(msg){
			if(msg=="yes"){
				$.ajax({
					url:"addStall",
					method:"POST",
					data:$("#statbstall").serialize()
				}).done(function(s){
					swal({  title: "สำเร็จ",   
