	...
	<div class="container">
								...
								<div class="form-inline">
									<div class="col-md-3">
										<div class="jumbotron" style="background-color: rgb(218, 68, 83)"
											align="center">
											<p style="font-size: 28px; font-weight: 700; color: white;">การตั้งค่าสายพันธุ์</p>
										</div>
									</div>	
								</div>
						</div>
						...
						<div class="row ">
        						...
        						<div class="panel panel-primary">
        							...
        							<div class="panel-body">
        								<table >
        									...
        									<tr>
        										<td><h4>สายพันธุ์ : </h4></td>
        										<td>
        										<form:form commandName="statb" id="statb" >
          				...
          				<div class="col-md-6">
           				 <div class="panel panel-primary">
             				 <div class="panel-heading">
                				<h3 class="panel-title">สายพันธุ์ที่มี</h3>
             				 </div>
						   	 		...
						   	 		<c:forEach items="${stat }" var="stat">
						     			<tr>	
						        			...
						        			<td>
												...
												value="${stat.id}" onclick="chkdel(this.value)">
...
$(document).on('click','#add',function(e){
	...
	{
		$.post('Checkbreed',{value:$("#value").val()},function(msg){
			if(msg=="yes"){
				$.ajax({
					url:"addStat",
					method:"POST",
					data:$("#statb").serialize()
				}).done(function(s){
					swal({  title: "สำเร็จ",   
