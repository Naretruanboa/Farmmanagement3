				...
				<!--admin -->
					<c:if test="${m.privilege.id==1 }">
					 	 <ul class="nav navbar-nav">
								...
								<li><a href="setlistdairy"><i class="fa fa-balance-scale" aria-hidden="true"></i> จัดสัดส่วนโคนม</a></li>

								<li><a href="calculatelowcost"><i class="fa fa-money" aria-hidden="true"></i> จัดสัดส่วนอาหารข้นราคาต่ำสุด</a></li>
								...
								<li><a href="<c:url value= "/resources/img/Nutrient/KUMU.pdf" />" target=_blank><img
